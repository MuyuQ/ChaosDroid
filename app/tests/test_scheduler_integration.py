...
def db_session():
    ...
    from app.models import Base, init_engine, get_session_factory
...
def test_full_scheduling_flow(db_session):
    ...
    from app.models.scenario import ScenarioTemplate, ScenarioRun
    from app.models.device_lease import DeviceLease
    from app.scheduling import Scheduler, PoolManager, LeaseManager
...
def test_emergency_preemption_flow(db_session):
    ...
    from app.models.scenario import ScenarioTemplate, ScenarioRun
    from app.models.device_lease import DeviceLease
    from app.scheduling import Scheduler, LeaseManager
