...
from app.scheduling.enums import DeviceStatus
from app.scheduling.device_sync import DeviceSyncService
...
def test_lease_status_enum():
    ...
    from app.scheduling.enums import LeaseStatus
...
def test_priority_enum():
    ...
    from app.scheduling.enums import Priority
...
def test_event_type_enum():
    ...
    from app.scheduling.enums import EventType
...
def test_event_severity_enum():
    ...
    from app.scheduling.enums import EventSeverity
...
def test_lease_manager_create_lease(db_session):
    ...
    from app.scheduling.enums import LeaseStatus, DeviceStatus
...
def test_quarantine_service_quarantine_device(db_session, test_device):
    ...
    from app.scheduling.quarantine import QuarantineService
    from app.scheduling.enums import EventType, EventSeverity
...
def test_scheduler_schedule_once(db_session):
    ...
    from app.scheduling.enums import DeviceStatus, Priority
    from app.models.scenario import ScenarioRun
    from app.models.base import RunStatus
...
def test_scheduler_emergency_preemption(db_session):
    ...
    """
    from app.scheduling.scheduler import Scheduler
    from app.scheduling.enums import DeviceStatus, Priority, LeaseStatus
    from app.scheduling.lease_manager import LeaseManager
    from app.models.scenario import ScenarioRun
