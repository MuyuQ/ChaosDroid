...
from app.validators.base import BaseValidator, ValidationContext, ValidationResult
...
class ScenarioExecution:
    ...
    async def execute_with_lease(
        ...
        from app.models import get_session_context, Device, DeviceLease, ScenarioRun
        from app.scheduling import LeaseManager
        from app.scheduling.enums import DeviceStatus, LeaseStatus
